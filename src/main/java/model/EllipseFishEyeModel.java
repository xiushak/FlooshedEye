...
/**
 * A basic implementation of the {@link SimpleModel} interface.This one just maps each pixel of the
 * image onto a circle/oval to create a fisheye effect.
 */
public class EllipseFishEyeModel implements SimpleModel {
  ...
  /**
   * This implementation applies the filter on the center of the image, x and y inputs are not
   * used.
   */
  @Override
  ...
  public BufferedImage getImage() throws IllegalStateException {
    checkImageSet();
    return new BufferedImage(bi.getColorModel(), bi.copyData(null),
