...
/**
 * An extension of {@link FaceRecognitionFishEyeModel} that automatically fisheyes on a person's
 * forehead (or tries to).
 */
public class FaceRecognitionBigBrainModel extends FaceRecognitionFishEyeModel {
  ...
  /**
   * Constructor that sets the delegate to a {@link FishEyeModel} with no image uploaded and sets
   * the {@link FaceRecognition} delegate.
   */
  ...
  /**
   * Constructor that sets the delegate to given {@link SimpleModel} and {@link FaceRecognition}
   * delegate.
   */
  public FaceRecognitionBigBrainModel(FishEyeModel delegate,
      FaceRecognition faceRecognitionDelegate) {
    super(delegate, faceRecognitionDelegate);
  }

  /**
   * Constructor that sets the delegate to given {@link SimpleModel}, image, and {@link
   * FaceRecognition} delegate.
   */
  public FaceRecognitionBigBrainModel(FishEyeModel delegate, BufferedImage bi,
      FaceRecognition faceRecognitionDelegate) {
  ...
  /**
   * Automatically sets x y to a random face detected in the image so given x and y are ignored. If
   * no face is detected, applies the filter at coordinate (width/2, height/5) on the image.
   */
  @Override
