...
public interface MultiSimpleController {
   ...
   */
  void addImage(int index, File file, SimpleModel delegate)
   ...
   * @throws IllegalArgumentException if a null image, null delegate, or invalid index is given
   */
  void setImage(int index, File file, SimpleModel delegate)
      throws IllegalArgumentException, IOException;
   ...
   */
  void outputImage(int index, String filename)
      throws IllegalArgumentException, IllegalStateException, IOException;

  /**
   * Exports all images with the same name into a new folder called "fisheyed". All images that
   * throw an error when being exported will be skipped.
   */
  void outputAll();
}
